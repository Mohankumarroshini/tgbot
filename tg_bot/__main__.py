...
HELP_STRINGS = """
Hey there! My name is *{Kratos ProBot}*.
...
It took lots of work for [my creator](t.me/My_Dear_Lightbright) to get me to where I am now, and every donation helps \
motivate him to make me even better. All the donation money will go to a better VPS to host me, and/or beer \
(see his bio!). He's just a poor student, so every little helps!
There are two ways of paying him; [PayPal](paypal.me/My_Dear_Lightbright)."""
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/Kratos_probot?startgroup=true".format(bot.username))],
                     ...
                     [InlineKeyboardButton(text=" InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(Kratos_probot)) ]]))
